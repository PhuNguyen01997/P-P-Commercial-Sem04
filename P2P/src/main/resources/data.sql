...
(NOW(), 'Áo thun', '[]', 'Áo thun', 200000.0, NOW(), 1, 1, 0),
(NOW(), 'Quần dài', '[]', 'Quần dài', 350000.0, NOW(), 1, 1, 0),
(NOW(), 'Iphone13', '[]', 'Iphone 13', 30000000, NOW(), 2, 1, 0),
(NOW(), 'Ma túy đá', '[]', 'Ma túy đá', 2900000.0, NOW(), 3, 2, 0),
(NOW(), 'Mã tấu', '[]', 'Mã tấu', 4200000.0, NOW(), 4, 2, 0);
